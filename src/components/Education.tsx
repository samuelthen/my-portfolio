...
const educations: EducationType[] = [
  {
    ...
    gpa: "GPA: 4.89/5.00 (Highest Distinction)",
    duration: "Aug 2023 – May 2027",
    image: "/images/nus.png",
    description: [
      "AI Focus Area Certificate of Distinction; NUS ASEAN Merit Scholarship",
      "Dean's List: AY23/24 Semester 2, AY24/25 Semester 2, and AY25/26 Semester 1",
      "Leadership: Director of Software Development, NUS Fintech Society; Product Associate, Google Developer Group",
    ]
  },
  {
    ...
    image: "/images/uw.png",
    description: [
      "Completed an exchange programme at the Paul G. Allen School of Computer Science & Engineering."
    ]
  },
  {
